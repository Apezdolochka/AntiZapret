start "antizapret: general" /min "%~dp0winws.exe" --wf-tcp=80,443 --wf-udp=443,50000-50100 ^
...
--filter-tcp=443 --hostlist="%~dp0list-general.txt" --dpi-desync=disorder --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%~dp0tls_clienthello_www_google_com.bin"
